...
import sameGameTris.GUI;
import sameGameTris.CircleColor;
...
public class smarterBrain extends Brain {
    ...
    private pos chooseMove() {
        ...
        cnt += 2;
        System.out.println(currState.columns());
        if (cnt > 24) {
            int x = (cnt % 9) + cnt % 2;
            bestPos = new pos(x, 0);
        }
...
//                if (currState.rows(xx) >  6) {
//                    System.out.println(currState.rows(xx) + " col" + xx);
//                    bestPos = new pos(xx, 0);
//                    t = 1;
//                    break;
//                }
//            }
